...
export function TermsCondition() {
  return (
    <Box mx={2}>
      ...
      <Typography variant="body1">Welcome to World Of Books!</Typography>

      <Typography variant="body1">
        These terms and conditions outline the rules and regulations for the use of Project Corporation 's Website,
        located at https://worldofbooksproject.netlify.app/.
      </Typography>

      <Typography variant="body1">
        By accessing this website we assume you accept these terms and conditions. Do not continue to use World Of Books
      ...
      <Typography variant="body1">
        We employ the use of cookies. By accessing World Of Books, you agreed to use cookies in agreement with the
      ...
      <Typography variant="body1">
        ...
        material on World Of Books. All intellectual property rights are reserved. You may access this from World Of
      ...
      <ul>
        <li>Republish material from World Of Books</li>
        <li>Sell, rent or sub-license material from World Of Books</li>
        <li>Reproduce, duplicate or copy material from World Of Books</li>
        <li>Redistribute content from World Of Books</li>
      </ul>
      ...
      <Typography variant="body1">You warrant and represent that:</Typography>
      ...
      <Typography variant="body1">Approved organizations may hyperlink to our Website as follows:</Typography>
